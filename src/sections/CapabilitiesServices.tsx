	...
	const dimensions = [
		{
			...
			description:
				"Diseño de arquitecturas escalables, MicroFrontends, optimización de performance y decisiones técnicas para empresas.",
			keywords: [
				"MicroFrontends",
				"Webpack 5",
				"Module Federation",
		...
		},
		{
			...
			description:
				"Metodología Piloto Cancelable: proyectos de 4 semanas con ROI medible para startups y PYMEs.",
			keywords: [
				"Piloto Cancelable",
				"ROI Analysis",
		...
		},
		{
			...
			title: "Líder Técnico",
			description:
				"Escalado de equipos de 5 a 25 desarrolladores, establecimiento de estándares y mentoría senior.",
			keywords: [
				"Team Scaling",
				"Code Reviews",
				"Mentorship",
		...
		},
		{
			...
			description:
				"Implementaciones de IA de bajo costo (DeepSeek, Minimax) con ahorros de hasta 60% vs GPT-4.",
			keywords: [
				"DeepSeek API",
				"Minimax",
				"AI Pipelines",
