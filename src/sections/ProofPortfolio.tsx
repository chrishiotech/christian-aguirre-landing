  ...
  const projects = [
    {
      ...
      description: 'Aplicación empresarial con NgRx, lazy loading y testing completo.',
    ...
    },
    {
      ...
      description: 'Arquitectura MicroFrontend con Webpack 5 Module Federation.',
      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-12">
          {projects.map((project) => (
            <div key={project.id} className="border-2 border-gray-200 rounded-2xl p-8 hover:shadow-xl transition">
